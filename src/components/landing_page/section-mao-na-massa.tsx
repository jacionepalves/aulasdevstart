                ...
                <div className="w-1/2">
                    ...
                    <div>
                        ...
                        <p className="text-xl text-gray-600 mt-4 max-w-4xl text-left tracking-[1px]">
                            O nextbite food acredita que só é bom quando é bom pra todo mundo. E prova isso contribuindo 
                            com mais de 30 mil lojistas parceiros, transformando a economia local de mais de 700 cidades,
                            oferecendo o melhor para todos os entregadores e construindo uma relação verdadeira com quem
                            escolhe consumir com a gente.
                        </p>
                    </div>
                </div>
                <div className="w-1/2 flex justify-center">
                    <img 
                    src={assets.imageMaonaMassa} 
                    alt="" 
